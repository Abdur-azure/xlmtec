...
def generate(
    ...
    Example:
        xlmtec config generate --output my_config.json --method lora
    """
...
def validate(
    ...
    Example:
        xlmtec config validate ./config.json
    """
...
def show(
    ...
    Example:
        xlmtec config show ./config.json
        xlmtec config show ./config.json --section training
    """
...
def templates():
    ...
    console.print("  xlmtec config generate --method <method> --output config.json")
