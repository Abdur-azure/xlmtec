...
def run(
    ...
    Example:
        xlmtec evaluate --model ./outputs --dataset ./test.jsonl --metric rouge1 --metric bleu
    """
...
def benchmark(
    ...
    Example:
        xlmtec evaluate benchmark --base gpt2 --finetuned ./outputs --dataset ./test.jsonl
    """
...
def quick(
    ...
    Example:
        xlmtec evaluate quick ./outputs ./test.jsonl
    """
